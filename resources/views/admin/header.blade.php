...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="{{ asset('plugins/datatables-buttons/css/buttons.dataTables.min.css')}}"> -->
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        <!-- <div class="preloader flex-column justify-content-center align-items-center" style="height: 0px;">
            <img class="animation__shake" src="{{asset('dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60" style="display: none;">
        </div> -->
         <!-- Navbar -->
