    ...
    public function index(Request $request)
    {
        if ($request->ajax()){
            ...
            ->addColumn('actions', function($row) use($baseurl){
                ...
                <a class='btn btn-dark btn-flat btn-sm module_view_record' data-id='".$row->id."' data-url='".$baseurl."' title='View'><i class='text-info fas fa-eye'></i></a>
                <a class='btn btn-dark btn-flat btn-sm module_edit_record' data-id='".$row->id."' data-url='".$baseurl."' title='Edit'><i class='text-warning far fa-edit'></i></a>
                <a class='btn btn-dark btn-flat btn-sm module_delete_record' data-id='".$row->id."' data-url='".$baseurl."' title='Delete'><i class='text-danger far fa-trash-alt'></i></a>
                </div>";
                return $url;
            })
